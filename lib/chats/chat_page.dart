...
//     return Scaffold(
//       appBar: AppBar(
//         toolbarHeight: 120, // تحديد ارتفاع الـ AppBar
//         flexibleSpace: Container(
//           color: Colors.white,
//           padding: const EdgeInsets.symmetric(horizontal: 16.0),
//           child: Align(
...
//                                 children: [
//                                   CircleAvatar(
//                                     radius: 20, // زيادة حجم الصورة
//                                     backgroundImage:
//                                         NetworkImage(message.senderImageUrl),
//                                   ),
//                                   const SizedBox(
//                                       width: 10), // مسافة بين الصورة والاسم
//                                   Text(
//                                     isCurrentUser
//                                         ? "Me"
//                                         : message.senderName, // اسم الراسل
//                                     style: TextStyle(
//                                       fontWeight: FontWeight.bold,
//                                       color: isCurrentUser
//                                           ? Colors.white
